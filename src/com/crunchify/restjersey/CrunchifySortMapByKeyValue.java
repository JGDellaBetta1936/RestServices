...
public class CrunchifySortMapByKeyValue {
	private static Random crunchifyRandom = new Random();
	static Logger log = Logger.getLogger(CrunchifySortMapByKeyValue.class.getName());

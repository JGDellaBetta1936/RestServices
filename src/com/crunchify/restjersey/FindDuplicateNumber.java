...
public class FindDuplicateNumber {
	...
	private static Logger log = Logger.getLogger(FindDuplicateNumber.class.getName());
	...
	public static void main(String [] args) {
		...
		for (int[] input : test) {
			log.info("Array with Duplicates       : " + Arrays.toString(input));
			log.info("After removing duplicates   : " + Arrays.toString(removeDuplicates(input)));
		}
	}
